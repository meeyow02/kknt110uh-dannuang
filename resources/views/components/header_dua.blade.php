<header class="px-12 py-2 bg-gray-900 absolute top-0 left-0 w-full flex items-center z-10">
    <div class="container">
        <div class="flex items-center justify-between relative">
            <div class="px-4 flex gap-4">
                <a class="" href="https://bulukumbakab.go.id/sejarah-kabupaten-bulukumba">
            ...
            <div class="flex items-center px-4">
                ...
                <nav id="nav-menu" class="hidden absolute py-4 md:px-8 md:py-5 bg-gray-800 shadow-lg rounded-lg max-w-[300px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                    <ul class="block lg:flex gap-12">
                        ...
                        <li class="group">
                            <a href="{{ route('info.index') }}" class="{{ request()->routeIs('info.index', 'info.show') ? 'text-blue-500 text-lg py-2 mx-8' : 'text-lg text-gray-400 py-2 mx-8 group-hover:text-blue-700'}}">Informasi</a>
                        </li>
                        <li class="group">
                        ...
                        @auth
                        <li class="group">
                            <a href="{{ route('post.index') }}" class="{{ request()->routeIs('post.index', 'post.show', 'post.edit') ? 'text-blue-500 text-lg py-2 mx-8' : 'text-lg text-gray-400 py-2 mx-8 group-hover:text-blue-700'}}">Post</a>
                        </li>
                        <li class="group">
